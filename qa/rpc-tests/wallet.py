...
#   c) node1 mines 32 blocks, so now node 0 has 60001rld, node 1 has 4250rld, node2 has none.
#   d) node0 sends 601 rld to node2, in two transactions (301 rld, then 300 rld).
