...
RESOURCES += src/qt/rld.qrc src/qt/rld_locale.qrc

TRANSLATIONS += src/qt/locale/rld_bg.ts \
                src/qt/locale/rld_de.ts \
                src/qt/locale/rld_en.ts \
                src/qt/locale/rld_es.ts \
                src/qt/locale/rld_fi.ts \
                src/qt/locale/rld_fr.ts \
                src/qt/locale/rld_it.ts \
                src/qt/locale/rld_ja.ts \
                src/qt/locale/rld_pl.ts \
                src/qt/locale/rld_pt.ts \
                src/qt/locale/rld_ru.ts \
                src/qt/locale/rld_sk.ts \
                src/qt/locale/rld_sv.ts \
                src/qt/locale/rld_vi.ts \
                src/qt/locale/rld_zh_CN.ts \
                src/qt/locale/rld_zh_TW.ts
