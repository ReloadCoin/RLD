...
This means one can have an always-on rldd instance running, and another local rldd/rld-qt instance which connects to this node and receives blocks from it.
