...
This mechanism has been integrated into Bitcore-Node-RLD which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/RLD-Project/insight-api-rld#web-socket-api](https://github.com/RLD-Project/insight-api-rld#web-socket-api) 
* API: [https://github.com/RLD-Project/insight-api-rld#swifttx-transactions](https://github.com/RLD-Project/insight-api-rld#swifttx-transactions) 
...
By default, the RLD Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RLD Core daemon:
