...
In order to support loading of multiple wallets in rld-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rld.cpp.
...
Changes to rld.cpp
----------------------
rld.cpp is the entry point into rld-qt, and as such, will require some minor modifications to provide hooks for
