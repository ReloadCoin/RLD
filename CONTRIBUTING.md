Contributing to RLD Core
============================

The RLD Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RLD Core project, and is not to be
confused with overall RLD Network Protocol consensus changes.

Whether a pull request is merged into RLD Core rests with the project merge
...
Patches that change RLD consensus rules are considerably more involved than
...
Where a patch set proposes to change the RLD consensus, it must have been
...
The project leader is the release manager for each RLD Core release.
