                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RLD-Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RLD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rld: URIs)"));
...
//    privacyAction->setStatusTip(tr("Privacy Actions for zRLD"));
...
//    tabGroup->addAction(privacyAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RLD Core"), this);
    aboutAction->setStatusTip(tr("Show information about RLD Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RLD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RLD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RLD addresses"));
    ...
    openAction->setStatusTip(tr("Open a RLD: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RLD Core help message to get a list with possible RLD command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RLD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RLD network", "", count));
}
...
{
    QString strTitle = tr("RLD-Core"); // default title
