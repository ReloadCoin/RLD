                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRLDPathCustom = GetArg("-zrldbackuppath", "");
    ...
    if(!strzRLDPathCustom.empty()) {
        ui->wallet_customzrldbackuppath->setText(QString::fromStdString(strzRLDPathCustom));
        ui->wallet_customzrldbackuppath_label->setVisible(true);
        ui->wallet_customzrldbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRLDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RLD RPC console.") + "<br>" +
