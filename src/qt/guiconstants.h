...
/* Rld GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "RLD-Core"
#define QAPP_ORG_DOMAIN "rldcoin.io"
#define QAPP_APP_NAME_DEFAULT "RLD-Qt"
#define QAPP_APP_NAME_TESTNET "RLD-Qt-testnet"
