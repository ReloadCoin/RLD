...
extern UniValue setzrldseed(const UniValue& params, bool fHelp);
extern UniValue getzrldseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzrld(const UniValue& params, bool fHelp);
extern UniValue dzrldstate(const UniValue& params, bool fHelp);
