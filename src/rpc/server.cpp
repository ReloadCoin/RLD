...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RLD features */
        {"rld", "masternode", &masternode, true, true, false},
        {"rld", "listmasternodes", &listmasternodes, true, true, false},
        {"rld", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rld", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rld", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"rld", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"rld", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"rld", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rld", "masternodedebug", &masternodedebug, true, true, false},
        {"rld", "startmasternode", &startmasternode, true, true, false},
        {"rld", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rld", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rld", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rld", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rld", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rld", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rld", "mnbudget", &mnbudget, true, true, false},
        {"rld", "preparebudget", &preparebudget, true, true, false},
        {"rld", "submitbudget", &submitbudget, true, true, false},
        {"rld", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rld", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rld", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rld", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rld", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rld", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rld", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rld", "checkbudgets", &checkbudgets, true, true, false},
        {"rld", "mnsync", &mnsync, true, true, false},
        {"rld", "spork", &spork, true, true, false},
        {"rld", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzrldseed", &getzrldseed, false, false, true},
        {"zerocoin", "setzrldseed", &setzrldseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzrld", &searchdzrld, false, false, true},
        {"zerocoin", "dzrldstate", &dzrldstate, false, false, true}
...
{
    return "> rld-cli " + methodname + " " + args + "\n";
}
