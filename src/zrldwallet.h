...
#ifndef RLD_ZRLDWALLET_H
#define RLD_ZRLDWALLET_H
...
public:
    CzRLDWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRLD(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRLD(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
